...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v0.5.2"
  WORKING_DIRECTORY "/home/michael/Documents/vara-feature/_deps/corrosion-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/michael/Documents/vara-feature/_deps/corrosion-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/michael/Documents/vara-feature/_deps/corrosion-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
