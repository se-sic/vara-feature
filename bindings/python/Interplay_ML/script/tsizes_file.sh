#!/bin/bash
#SBATCH --job-name=tsizes_file
#SBATCH --output=/scratch/mani00001/slurm_logs/tsizes_file_%A_%a.out
...
python -m bindings.python.Interplay_ML.Sampling.Controller writetsizes "$SYS" "$T"