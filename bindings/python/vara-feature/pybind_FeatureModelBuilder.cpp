...
void init_feature_model_builder_module(py::module &M) {
  py::class_<vf::FeatureModelBuilder>(M, "FeatureModelBuilder")
      .def(py::init([]() { return vf::FeatureModelBuilder(); }))
      .def(
          "make_binary_feature",
      ...
      .def(
          "add_an_edge",
          [](vf::FeatureModelBuilder &FMB, std::string parent_name,
      ...
      .def(
          ...
          [](vf::FeatureModelBuilder &FMB, vf::Constraint &C) {
            return FMB.addConstraint(
                std::make_unique<vf::FeatureModel::BooleanConstraint>(
                    C.clone()));
          },
      ...
      .def(
          ...
          [](vf::FeatureModelBuilder &FMB, vf::Constraint &C) {
            return FMB.addConstraint(
                std::make_unique<vf::FeatureModel::NonBooleanConstraint>(
                    C.clone()));
          },
      ...
      .def(
          "build_feature_model",
          [](vf::FeatureModelBuilder &FMB) { return FMB.buildFeatureModel(); },
