if(NOT IN_TREE)
  ...
  macro(ADD_VARA_EXECUTABLE name)
    if(VARA_FEATURE_IN_TREE)
      ...
      set_target_properties(
        ${name} PROPERTIES FOLDER "vara-feature executables"
      )
  ...
  function(add_vara_library name)
    ...
    target_link_directories(${name} PRIVATE ${CMAKE_BINARY_DIR}/lib/Solver)
    target_link_libraries(${name} PRIVATE VaRASolver)
