...
UVLcppLexer::UVLcppLexer(CharStream *input) : Lexer(input) {
...
const std::vector<uint16_t> UVLcppLexer::getSerializedATN() const {
...
std::vector<dfa::DFA> UVLcppLexer::_decisionToDFA;
atn::PredictionContextCache UVLcppLexer::_sharedContextCache;

// We own the ATN which in turn owns the ATN states.
atn::ATN UVLcppLexer::_atn;
std::vector<uint16_t> UVLcppLexer::_serializedATN;

std::vector<std::string> UVLcppLexer::_ruleNames = {
...
dfa::Vocabulary UVLcppLexer::_vocabulary(_literalNames, _symbolicNames);

std::vector<std::string> UVLcppLexer::_tokenNames;

UVLcppLexer::Initializer::Initializer() {
...
UVLcppLexer::Initializer UVLcppLexer::_init;
