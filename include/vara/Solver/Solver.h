...
public:
  ...
  /// mandatory.
  ///
  /// \param FeatureToAdd the feature that should be added.
  /// \param IsInAlternativeGroup whether the feature is in an alternative group
  /// or not.
  ///
  ...
  ///
  /// \param FeatureName the name of the boolean feature to add
  ///
  ...
  /// If this is not intended, use the other methods, instead.
  ///
  /// \param FeatureName the name of the numeric feature to add.
  /// \param Values the values that the numeric feature can have.
  ///
  ...
  /// is included in.
  /// Note that this method may not be supported by some solvers.
  ///
  /// \param FeatureToRemove the feature that should be removed from the solver.
  ///
  ...
  ///
  /// \param ConstraintToAdd the constraint that should be added.
  ///
  ...
  ///
  /// \param ConstraintToAdd the mixed constraint to add.
  /// \param ExprKind the kind of expression: whether the constraint should be
  /// negated (`neg`) or not (`pos`).
  /// \param Req whether the constraint evaluates to `false` (`all`) if not all
  /// boolean features are selected or not (`none`).
  ///
  /// \returns a possible error if adding the constraint could not be done.
  virtual Result<SolverErrorCode>
